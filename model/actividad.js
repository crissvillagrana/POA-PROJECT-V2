module.exports={
    ...
    leerporareat1(conexion,areaid,funcion){
        conexion.query("select actividades.actividad_id, actividades.actividad_eje, actividades.actividad_estrategia, actividades.actividad_desc, areas.area_nombre, responsables.responsable_desc,"+
        "actividades.actividad_meta, actividades.actividad_indicador, actividades.actividad_unidad,"+
        "actividades.actividad_t1, actividades.actividad_evt1, actividades.actividad_obst1, actividades.actividad_ap1, "+
        "actividades.actividad_completada, actividades.actividad_status from (actividades inner join areas on actividades.actividad_area = areas.area_id)"+
    ...
    leerporareat2(conexion,areaid,funcion){
        conexion.query("select actividades.actividad_id, actividades.actividad_eje, actividades.actividad_estrategia, actividades.actividad_desc, areas.area_nombre, responsables.responsable_desc,"+
        "actividades.actividad_meta, actividades.actividad_indicador, actividades.actividad_unidad, "+
        "actividades.actividad_t2, actividades.actividad_evt2, actividades.actividad_obst2, actividades.actividad_ap2, "+
        "actividades.actividad_completada, actividades.actividad_status from (actividades inner join areas on actividades.actividad_area = areas.area_id)"+
        "inner join responsables on actividades.actividad_responsable = responsables.responsable_id where actividades.actividad_status=1 and actividades.actividad_area = ?",[areaid],funcion)
    },
    leerporareat3(conexion,areaid,funcion){
        conexion.query("select actividades.actividad_id, actividades.actividad_eje, actividades.actividad_estrategia, actividades.actividad_desc, areas.area_nombre, responsables.responsable_desc,"+
        "actividades.actividad_meta, actividades.actividad_indicador, actividades.actividad_unidad,"+
        "actividades.actividad_t3, actividades.actividad_evt3, actividades.actividad_obst3, actividades.actividad_ap3, "+
        "actividades.actividad_completada, actividades.actividad_status from (actividades inner join areas on actividades.actividad_area = areas.area_id)"+
        "inner join responsables on actividades.actividad_responsable = responsables.responsable_id where actividades.actividad_status=1 and actividades.actividad_area = ?",[areaid],funcion)
    },
    leerporareat4(conexion,areaid,funcion){
        conexion.query("select actividades.actividad_id, actividades.actividad_eje, actividades.actividad_estrategia, actividades.actividad_desc, areas.area_nombre, responsables.responsable_desc,"+
        "actividades.actividad_meta, actividades.actividad_indicador, actividades.actividad_unidad,"+
        "actividades.actividad_t4, actividades.actividad_evt4, actividades.actividad_obst4, actividades.actividad_ap4, "+
        "actividades.actividad_completada, actividades.actividad_status from (actividades inner join areas on actividades.actividad_area = areas.area_id)"+
        "inner join responsables on actividades.actividad_responsable = responsables.responsable_id where actividades.actividad_status=1 and actividades.actividad_area = ?",[areaid],funcion)
    },
    ...
    aprovet1(conexion,funcion){
        conexion.query("select actividades.actividad_id, actividades.actividad_eje, actividades.actividad_estrategia, actividades.actividad_desc, areas.area_nombre, responsables.responsable_desc,"+
        "actividades.actividad_meta, actividades.actividad_indicador, actividades.actividad_unidad,"+
        "actividades.actividad_t1, actividades.actividad_evt1, actividades.actividad_obst1, actividad_ap1,"+
        "actividades.actividad_completada, actividades.actividad_status from (actividades inner join areas on actividades.actividad_area = areas.area_id)"+
        " inner join responsables on actividades.actividad_responsable = responsables.responsable_id "+
        "where actividades.actividad_status=1",funcion)
    },
    aprovet2(conexion,funcion){
        conexion.query("select actividades.actividad_id, actividades.actividad_eje, actividades.actividad_estrategia, actividades.actividad_desc, areas.area_nombre, responsables.responsable_desc,"+
        "actividades.actividad_meta, actividades.actividad_indicador, actividades.actividad_unidad,"+
        "actividades.actividad_t2, actividades.actividad_evt2, actividades.actividad_obst2, actividad_ap2,"+
        "actividades.actividad_completada, actividades.actividad_status from (actividades inner join areas on actividades.actividad_area = areas.area_id)"+
        " inner join responsables on actividades.actividad_responsable = responsables.responsable_id "+
        "where actividades.actividad_status=1",funcion)
    },
    aprovet3(conexion,funcion){
        conexion.query("select actividades.actividad_id, actividades.actividad_eje, actividades.actividad_estrategia, actividades.actividad_desc, areas.area_nombre, responsables.responsable_desc,"+
        "actividades.actividad_meta, actividades.actividad_indicador, actividades.actividad_unidad,"+
        "actividades.actividad_t3, actividades.actividad_evt3, actividades.actividad_obst3, actividad_ap3,"+
        "actividades.actividad_completada, actividades.actividad_status from (actividades inner join areas on actividades.actividad_area = areas.area_id)"+
        " inner join responsables on actividades.actividad_responsable = responsables.responsable_id "+
        "where actividades.actividad_status=1",funcion)
    },
    aprovet4(conexion,funcion){
        conexion.query("select actividades.actividad_id, actividades.actividad_eje, actividades.actividad_estrategia, actividades.actividad_desc, areas.area_nombre, responsables.responsable_desc,"+
        "actividades.actividad_meta, actividades.actividad_indicador, actividades.actividad_unidad,"+
        "actividades.actividad_t4, actividades.actividad_evt4, actividades.actividad_obst4, actividad_ap4,"+
        "actividades.actividad_completada, actividades.actividad_status from (actividades inner join areas on actividades.actividad_area = areas.area_id)"+
        " inner join responsables on actividades.actividad_responsable = responsables.responsable_id "+
        "where actividades.actividad_status=1",funcion)
    },
